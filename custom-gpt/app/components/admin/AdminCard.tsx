...
const AdminCard: React.FC<AdminCardProps> = ({
    ...
    return (
        <div 
            className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all cursor-pointer"
            onClick={onClick}
        >
            ...
            <div className="p-4">
                <h3 className="font-medium text-base mb-1 truncate text-gray-900 dark:text-white">{gpt.name}</h3>
